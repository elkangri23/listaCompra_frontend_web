      ...
      <div className="layout-container flex h-full grow flex-col">
        ...
        <header className="flex items-center justify-between whitespace-nowrap border-b border-solid border-b-[#f0f2f5] px-10 py-3">
          <div className="flex items-center gap-4 text-[#111418]">
            <div className="size-10 rounded-full bg-[#4387f4] flex items-center justify-center">
              <svg className="size-6 text-white" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path
        ...
        <div className="px-4 md:px-40 flex flex-1 justify-center py-5">
          <div className="layout-content-container flex flex-col max-w-[960px] flex-1">
            ...
            <div className="p-4">
              <div
                className="flex min-h-[480px] flex-col gap-6 bg-cover bg-center bg-no-repeat rounded-lg items-center justify-center p-8 md:p-12"
                style={{
              ...
              >
                <div className="flex flex-col gap-4 text-center max-w-[640px]">
                ...
                <Link href="/register">
                  <button className="flex min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-[#4387f4] text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-[#3577e4] transition-colors">
            ...
            {/* Features Section */}
            <div id="caracteristicas" className="flex flex-col gap-10 px-4 py-10">
              <div className="flex flex-col gap-4">
                <h1 className="text-[#111418] tracking-light text-[32px] md:text-4xl font-bold leading-tight max-w-[720px]">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {/* IA Suggestions */}
                <div className="flex flex-1 gap-3 rounded-lg border border-[#dbdfe6] bg-white p-6 flex-col hover:shadow-md transition-shadow">
                  <div className="text-[#4387f4]">
                    <Sparkles size={32} />
                  </div>
                  <div className="flex flex-col gap-2">
                    <h2 className="text-[#111418] text-lg font-bold leading-tight">Sugerencias con IA</h2>
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#dbdfe6] bg-white p-6 flex-col hover:shadow-md transition-shadow">
                  ...
                  <div className="flex flex-col gap-2">
                    <h2 className="text-[#111418] text-lg font-bold leading-tight">Colaboración en Tiempo Real</h2>
                    <p className="text-[#60708a] text-sm font-normal leading-normal">
                ...
                <div className="flex flex-1 gap-3 rounded-lg border border-[#dbdfe6] bg-white p-6 flex-col hover:shadow-md transition-shadow">
                  ...
                  <div className="flex flex-col gap-2">
                    <h2 className="text-[#111418] text-lg font-bold leading-tight">Categorización Inteligente</h2>
                    <p className="text-[#60708a] text-sm font-normal leading-normal">
